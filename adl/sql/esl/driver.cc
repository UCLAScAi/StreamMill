...
namespace ESL {
	...
	{
		SMLog::SMLOG(10, "Entering buffer_entry::buffer_entry");	
	...
	{
		SMLog::SMLOG(10, "Entering buffer_entry::pop");	
	...
	{  
		SMLog::SMLOG(10, "Entering Driver::Driver");	
	...
	{
		SMLog::SMLOG(10, "Entering Driver::sendErrorForStmt");	
	...
	{
		SMLog::SMLOG(10, "Entering Driver::addStmt");	
	...
	int Driver::dropStmt(stmt *s){
		SMLog::SMLOG(10, "Entering Driver::dropStmt");	
...
{
	SMLog::SMLOG(10, "Entering Driver::setSink");	
	switch (entry->b_type) {
...
{
	SMLog::SMLOG(10, "Entering Driver::resetMarks");	
	for (BufStateTblType::iterator itr = bufStateTable->begin(); itr != bufStateTable->end(); itr++) {
...
{ 
        // TODO: Check if this is the places where the query (if it is defined incorrectly) crashes...
        // and if so, make this a separate process so that the crash no longer happens. 
	//This method is been called very frequently so I have to comment the log
	//SMLog::SMLOG(10, "Entering Driver::run");	
	if (*nTuples == 0) {
		*nTuples = priority;
	} 
	...
	{
		SMLog::SMLOG(10, "Entering Driver::runState");	
	...
	int DrvMgr::addStmt(stmt *s){
		SMLog::SMLOG(10, "Entering DrvMgr::addStmt");	
		Driver *dummy=NULL;
	...
	{
		SMLog::SMLOG(10, "Entering DrvMgr::addStmt 2");	
	...
	int DrvMgr::dropStmt(stmt *s, Driver* &drv){
		SMLog::SMLOG(10, "Entering DrvMgr::dropStmt");	
