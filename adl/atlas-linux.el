...
(defun atlas-run ()
  ...
  (let* ((class (if (buffer-file-name)
    ...
    (save-buffer)
   (shell-command (concat "adlc " buffer-file-name ) buf)
  (if (buffer-live-p buf) (display-buffer class)
    (let (buf1 (get-buffer-create class))
       (shell-command (concat "g++ -o" class " "class ".cc -I/home/lc/BerkeleyDB/include -I/home/lc/atlas/include /home/lc/atlas/lib/libadl.a /home/lc/atlas/lib/libdb.a /home/lc/atlas/lib/libimdb.a /home/lc/atlas/lib/librtree.a -ldl") buf1)
       (if (buffer-live-p buf1) (display-buffer class)
	 (shell-command class)
	 )
       )
