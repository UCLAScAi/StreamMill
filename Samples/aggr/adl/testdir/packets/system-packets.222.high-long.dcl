...
insert into s_extra select from_ip, to_ip, s_port, d_port, num_bytes, current_time from tcp1;
insert into s1 select from_ip, to_ip, s_port, d_port, num_bytes, a_time from s_extra;
