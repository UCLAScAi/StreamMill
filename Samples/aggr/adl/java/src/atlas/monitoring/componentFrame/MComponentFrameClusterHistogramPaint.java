...
import atlas.monitoring.component.MComponentClusterHistogramPaint;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class MComponentFrameClusterHistogramPaint extends MComponentFrame {
	...
	public MComponentFrameClusterHistogramPaint(String parameter_id, Integer dataType, Object[] objs) {
		super(new MComponentClusterHistogramPaint(objs), "MComponentFrameCluster", parameter_id, dataType.intValue(), null);
    ...
    protected JTabbedPane createTabbedPanelUI() {
        ...
        tabbedPane.addTab("Cluster",null,((MComponentClusterHistogramPaint)_monitoringComponent).GetClusterArea(),"Cluster");
        tabbedPane.addTab("Histogram",null,((MComponentClusterHistogramPaint)_monitoringComponent).GetHistogramArea(),"Histogram");
	...
	public void AddValue(String[] strings) {
		...
		try {
			...
			((MComponentClusterHistogramPaint)_monitoringComponent).AddClusterElementValue(x,y,clusterId,slideWindowIdx);
	...
	// Menu Action 
	//Start Pause - Clear
	public class HistogramAction extends AbstractAction implements Serializable {
	    
		public HistogramAction() {
	      super("HistogramAction");
	    }
	...
	public class ClusterAction extends AbstractAction implements Serializable {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
		    	...
		    	if(_tabbedPane.getSelectedIndex()==0) {
		    		rendImage = ((MComponentClusterHistogramPaint)_monitoringComponent).SnapShotCluster();
		    	}
		    	else {
		    		rendImage = ((MComponentClusterHistogramPaint)_monitoringComponent).SnapShotHistogram();
		    	}
