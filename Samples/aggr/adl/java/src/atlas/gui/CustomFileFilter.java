...
public class CustomFileFilter extends FileFilter {
     ...
     * Example: new CustomFileFilter("jpg");
     *
     * @see #addExtension
     */
     ...
     * Example: new CustomFileFilter("jpg", "JPEG Image Images");
     *
     ...
     * Example: new CustomFileFilter(String {"gif", "jpg"});
     *
     ...
     * Example: new CustomFileFilter(String {"gif", "jpg"}, "Gif and JPG Images");
     *
