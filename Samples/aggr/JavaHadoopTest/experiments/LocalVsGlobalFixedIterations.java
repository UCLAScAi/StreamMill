...
public class LocalVsGlobalFixedIterations {
	...
	public static class TokenizerMapper 
		extends Mapper<Object, Text, Text, IntWritable>{
			...
			LocalVsGlobalFixedIterations sa = new LocalVsGlobalFixedIterations(); 
	...
	public static void main(String[] args) throws Exception {
		...
		while (simpleCount < numOfIterations) {
			...
			job.setJarByClass(LocalVsGlobalFixedIterations.class);
		...
		org.apache.hadoop.mapreduce.Counter c = job.getCounters().findCounter("LocalVsGlobalFixedIterations$TotalSum","STARTS_WITH_DIGIT");
		if (onlyLocalIteration)
