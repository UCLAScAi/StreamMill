...
{
	querySchdl::SMLOG(10, "Entering nStmt::nStmt");	
	type = stmt_normal;
...
{
	querySchdl::SMLOG(10, "Entering nStmt::exe");	
...
{
	querySchdl::SMLOG(10, "Entering utStmt::utStmt");	
	type = stmt_t_union;
	strcpy(this->name, name);
	in = 0;
	out = o;
...
{
	querySchdl::SMLOG(10, "Entering utStmt::exe_set_in");	
...
{
	querySchdl::SMLOG(10, "Entering utlStmt::utlStmt");	
	type = stmt_tl_union;
	strcpy(this->name, name);
	in = 0;
	out = o;
...
{
	querySchdl::SMLOG(10, "Entering utlStmt::exe_set_in");	
...
{
	querySchdl::SMLOG(10, "Entering cStmt::cStmt");	
	type = stmt_coll;
	strcpy(this->name, name);
	this->sub_stmt = 0;
}
...
{
	querySchdl::SMLOG(10, "Entering cStmt::cStmt 2");	
	type = stmt_coll;
	strcpy(this->name, name);
	addSubStmt(sub_stmt);
	this->sub_stmt = 0;
...
void cStmt::addSubStmt(stmt* s) {
	querySchdl::SMLOG(10, "Entering cStmt::addSubStmt");	
	list<stmt*> toRemove;
...
{
	querySchdl::SMLOG(10, "Entering jStmt::jStmt");	
	type = stmt_join;
	strcpy(this->name, name);
	in = i;
	out = o;
...
{
	querySchdl::SMLOG(10, "Entering jStmt::exe_set_backbuf");	
